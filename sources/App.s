...
appColorTable:
    ...
    .db     (VDP_COLOR_BLACK        << 4) | VDP_COLOR_DARK_GREEN,   (VDP_COLOR_BLACK        << 4) | VDP_COLOR_DARK_GREEN
    .db     (VDP_COLOR_DARK_RED     << 4) | VDP_COLOR_BLACK,        (VDP_COLOR_DARK_YELLOW  << 4) | VDP_COLOR_BLACK
    .db     (VDP_COLOR_DARK_GREEN   << 4) | VDP_COLOR_BLACK,        (VDP_COLOR_WHITE        << 4) | VDP_COLOR_BLACK
    .db     (VDP_COLOR_LIGHT_BLUE   << 4) | VDP_COLOR_BLACK,        (VDP_COLOR_MEDIUM_RED   << 4) | VDP_COLOR_BLACK
    .db     (VDP_COLOR_MEDIUM_GREEN << 4) | VDP_COLOR_BLACK,        (VDP_COLOR_LIGHT_YELLOW << 4) | VDP_COLOR_BLACK
    .db     (VDP_COLOR_LIGHT_RED    << 4) | VDP_COLOR_BLACK,        (VDP_COLOR_LIGHT_GREEN  << 4) | VDP_COLOR_BLACK
    .db     (VDP_COLOR_DARK_BLUE    << 4) | VDP_COLOR_BLACK,        (VDP_COLOR_WHITE        << 4) | VDP_COLOR_BLACK
    .db     (VDP_COLOR_CYAN         << 4) | VDP_COLOR_BLACK,        (VDP_COLOR_CYAN         << 4) | VDP_COLOR_BLACK
    ...
    .db     (VDP_COLOR_DARK_GREEN   << 4) | VDP_COLOR_BLACK,        (VDP_COLOR_DARK_GREEN   << 4) | VDP_COLOR_BLACK
